    ...
    def _evidence_template(event: RaceEvent, cutoff: str) -> dict[str, Any]:
        return {
            ...
            "example_claim": {
                ...
                "metric": "race_pace|race_execution|qualifying_pace|power_unit|energy_recovery|straight_line_speed|drag_efficiency|low_speed_traction|launch_performance|weight|upgrade_effect|tyre_deg|reliability|wet_skill|strategy|setup_quality",
                "direction": "positive",
                "magnitude": 0.03,
                "confidence": 0.5,
                "uncertainty": 0.35,
