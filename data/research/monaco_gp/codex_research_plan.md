# Codex Research Plan: Monaco Grand Prix
...
- task_id: `monaco_gp:f1-official-fia`
- source_class: `f1_official`
- priority: `P0`
- reliability_floor: `0.9`
- model_metrics: `reliability, strategy, qualifying_pace`
- queries:
  - Monaco Grand Prix 2026-06-07 Formula 1 official preview classification
  - Monaco Grand Prix 2026-06-07 FIA documents race director notes
  - Monaco Grand Prix 2026-06-07 penalties grid changes FIA
- acceptance:
...
- task_id: `monaco_gp:team-updates-track-fit`
...
- queries:
  - Monaco Grand Prix 2026-06-07 team upgrades Mercedes Ferrari McLaren Red Bull Racing
  - Monaco Grand Prix 2026-06-07 track characteristics street F1
  - Monaco Grand Prix 2026-06-07 Mercedes Ferrari McLaren Red Bull preview
- acceptance:
...
- task_id: `monaco_gp:weather`
- source_class: `weather`
- priority: `P0`
- reliability_floor: `0.7`
- model_metrics: `wet_skill, strategy, reliability, qualifying_pace`
- queries:
  - Monaco Grand Prix 2026-06-07 weather forecast race rain wind track temperature
  - Monaco Grand Prix 2026-06-07 circuit weather radar F1
  - Monaco Grand Prix 2026-06-07 qualifying race forecast
- acceptance:
...
- task_id: `monaco_gp:structured-session-data`
...
- queries:
  - OpenF1 Monaco Grand Prix 2026-06-07 laps stints weather race control
  - FastF1 Monaco Grand Prix 2026-06-07 session results lap times
  - Monaco Grand Prix 2026-06-07 long run pace tyre degradation F1
- acceptance:
...
- task_id: `monaco_gp:market-rules`
- source_class: `market`
- priority: `P1`
- reliability_floor: `0.65`
- model_metrics: `strategy`
- queries:
  - Monaco Grand Prix Polymarket winner market rules 2026-06-07
  - Monaco Grand Prix Polymarket F1 podium pole fastest lap market
  - Monaco Grand Prix prediction market final classification rules
- acceptance:
...
- task_id: `monaco_gp:independent-media-corroboration`
- source_class: `media`
- priority: `P2`
- reliability_floor: `0.7`
...
- queries:
  - Monaco Grand Prix 2026-06-07 F1 paddock notes named reporting
  - Monaco Grand Prix 2026-06-07 race preview upgrades reliability named sources
  - Monaco Grand Prix 2026-06-07 driver interviews team quotes
- acceptance:
...
## Tool Workflow
1. Run `python -m f1predict.cli prepare-research --event monaco_gp --knowledge-cutoff 2026-06-07T00:00:00+00:00` if workspace files are missing.
...
5. Run `python -m f1predict.cli archive-research-packet --input data/research/monaco_gp/research_packet_template.json --event monaco_gp --knowledge-cutoff 2026-06-07T00:00:00+00:00`.
6. Run `python -m f1predict.cli prediction-packet --event monaco_gp --knowledge-cutoff 2026-06-07T00:00:00+00:00 --iterations 1200 --write` before discussing edge quality.

## Output Contract
- research_packet_path: `data/research/monaco_gp/research_packet_template.json`
- draft_evidence_path: `data/research/monaco_gp/draft_evidence.jsonl`
- source_log_path: `data/research/monaco_gp/source_log.json`
- archive_command: `python -m f1predict.cli archive-research-packet --input data/research/monaco_gp/research_packet_template.json --event monaco_gp --knowledge-cutoff 2026-06-07T00:00:00+00:00`
