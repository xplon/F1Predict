# Codex Research Plan: Chinese Grand Prix
...
- task_id: `chinese_gp:f1-official-fia`
- source_class: `f1_official`
- priority: `P0`
- reliability_floor: `0.9`
- model_metrics: `reliability, strategy, qualifying_pace`
- queries:
  - Chinese Grand Prix 2026-03-15 Formula 1 official preview classification
  - Chinese Grand Prix 2026-03-15 FIA documents race director notes
  - Chinese Grand Prix 2026-03-15 penalties grid changes FIA
- acceptance:
...
- task_id: `chinese_gp:team-updates-track-fit`
...
- queries:
  - Chinese Grand Prix 2026-03-15 team upgrades Mercedes Ferrari McLaren Red Bull Racing
  - Chinese Grand Prix 2026-03-15 track characteristics power F1
  - Chinese Grand Prix 2026-03-15 Mercedes Ferrari McLaren Red Bull preview
- acceptance:
...
- task_id: `chinese_gp:weather`
- source_class: `weather`
- priority: `P0`
- reliability_floor: `0.7`
- model_metrics: `wet_skill, strategy, reliability, qualifying_pace`
- queries:
  - Chinese Grand Prix 2026-03-15 weather forecast race rain wind track temperature
  - Chinese Grand Prix 2026-03-15 circuit weather radar F1
  - Chinese Grand Prix 2026-03-15 qualifying race forecast
- acceptance:
...
- task_id: `chinese_gp:structured-session-data`
...
- queries:
  - OpenF1 Chinese Grand Prix 2026-03-15 laps stints weather race control
  - FastF1 Chinese Grand Prix 2026-03-15 session results lap times
  - Chinese Grand Prix 2026-03-15 long run pace tyre degradation F1
- acceptance:
...
- task_id: `chinese_gp:market-rules`
- source_class: `market`
- priority: `P1`
- reliability_floor: `0.65`
- model_metrics: `strategy`
- queries:
  - Chinese Grand Prix Polymarket winner market rules 2026-03-15
  - Chinese Grand Prix Polymarket F1 podium pole fastest lap market
  - Chinese Grand Prix prediction market final classification rules
- acceptance:
...
- task_id: `chinese_gp:independent-media-corroboration`
- source_class: `media`
- priority: `P2`
- reliability_floor: `0.7`
...
- queries:
  - Chinese Grand Prix 2026-03-15 F1 paddock notes named reporting
  - Chinese Grand Prix 2026-03-15 race preview upgrades reliability named sources
  - Chinese Grand Prix 2026-03-15 driver interviews team quotes
- acceptance:
...
## Tool Workflow
1. Run `python -m f1predict.cli prepare-research --event chinese_gp --knowledge-cutoff 2026-03-15T00:00:00+00:00` if workspace files are missing.
...
5. Run `python -m f1predict.cli archive-research-packet --input data/research/chinese_gp/research_packet_template.json --event chinese_gp --knowledge-cutoff 2026-03-15T00:00:00+00:00`.
6. Run `python -m f1predict.cli prediction-packet --event chinese_gp --knowledge-cutoff 2026-03-15T00:00:00+00:00 --iterations 1200 --write` before discussing edge quality.

## Output Contract
- research_packet_path: `data/research/chinese_gp/research_packet_template.json`
- draft_evidence_path: `data/research/chinese_gp/draft_evidence.jsonl`
- source_log_path: `data/research/chinese_gp/source_log.json`
- archive_command: `python -m f1predict.cli archive-research-packet --input data/research/chinese_gp/research_packet_template.json --event chinese_gp --knowledge-cutoff 2026-03-15T00:00:00+00:00`
