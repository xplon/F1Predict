# Codex Research Plan: Australian Grand Prix
...
- task_id: `australian_gp:f1-official-fia`
- source_class: `f1_official`
- priority: `P0`
- reliability_floor: `0.9`
- model_metrics: `reliability, strategy, qualifying_pace`
- queries:
  - Australian Grand Prix 2026-03-08 Formula 1 official preview classification
  - Australian Grand Prix 2026-03-08 FIA documents race director notes
  - Australian Grand Prix 2026-03-08 penalties grid changes FIA
- acceptance:
...
- task_id: `australian_gp:team-updates-track-fit`
...
- queries:
  - Australian Grand Prix 2026-03-08 team upgrades Mercedes Ferrari McLaren Red Bull Racing
  - Australian Grand Prix 2026-03-08 track characteristics street F1
  - Australian Grand Prix 2026-03-08 Mercedes Ferrari McLaren Red Bull preview
- acceptance:
...
- task_id: `australian_gp:weather`
- source_class: `weather`
- priority: `P0`
- reliability_floor: `0.7`
- model_metrics: `wet_skill, strategy, reliability, qualifying_pace`
- queries:
  - Australian Grand Prix 2026-03-08 weather forecast race rain wind track temperature
  - Australian Grand Prix 2026-03-08 circuit weather radar F1
  - Australian Grand Prix 2026-03-08 qualifying race forecast
- acceptance:
...
- task_id: `australian_gp:structured-session-data`
...
- queries:
  - OpenF1 Australian Grand Prix 2026-03-08 laps stints weather race control
  - FastF1 Australian Grand Prix 2026-03-08 session results lap times
  - Australian Grand Prix 2026-03-08 long run pace tyre degradation F1
- acceptance:
...
- task_id: `australian_gp:market-rules`
- source_class: `market`
- priority: `P1`
- reliability_floor: `0.65`
- model_metrics: `strategy`
- queries:
  - Australian Grand Prix Polymarket winner market rules 2026-03-08
  - Australian Grand Prix Polymarket F1 podium pole fastest lap market
  - Australian Grand Prix prediction market final classification rules
- acceptance:
...
- task_id: `australian_gp:independent-media-corroboration`
- source_class: `media`
- priority: `P2`
- reliability_floor: `0.7`
...
- queries:
  - Australian Grand Prix 2026-03-08 F1 paddock notes named reporting
  - Australian Grand Prix 2026-03-08 race preview upgrades reliability named sources
  - Australian Grand Prix 2026-03-08 driver interviews team quotes
- acceptance:
...
## Tool Workflow
1. Run `python -m f1predict.cli prepare-research --event australian_gp --knowledge-cutoff 2026-03-08T00:00:00+00:00` if workspace files are missing.
...
5. Run `python -m f1predict.cli archive-research-packet --input data/research/australian_gp/research_packet_template.json --event australian_gp --knowledge-cutoff 2026-03-08T00:00:00+00:00`.
6. Run `python -m f1predict.cli prediction-packet --event australian_gp --knowledge-cutoff 2026-03-08T00:00:00+00:00 --iterations 1200 --write` before discussing edge quality.

## Output Contract
- research_packet_path: `data/research/australian_gp/research_packet_template.json`
- draft_evidence_path: `data/research/australian_gp/draft_evidence.jsonl`
- source_log_path: `data/research/australian_gp/source_log.json`
- archive_command: `python -m f1predict.cli archive-research-packet --input data/research/australian_gp/research_packet_template.json --event australian_gp --knowledge-cutoff 2026-03-08T00:00:00+00:00`
