# Codex Research Plan: Canadian Grand Prix
...
- task_id: `canadian_gp:f1-official-fia`
- source_class: `f1_official`
- priority: `P0`
- reliability_floor: `0.9`
- model_metrics: `reliability, strategy, qualifying_pace`
- queries:
  - Canadian Grand Prix 2026-05-24 Formula 1 official preview classification
  - Canadian Grand Prix 2026-05-24 FIA documents race director notes
  - Canadian Grand Prix 2026-05-24 penalties grid changes FIA
- acceptance:
...
- task_id: `canadian_gp:team-updates-track-fit`
...
- queries:
  - Canadian Grand Prix 2026-05-24 team upgrades Mercedes Ferrari McLaren Red Bull Racing
  - Canadian Grand Prix 2026-05-24 track characteristics power F1
  - Canadian Grand Prix 2026-05-24 Mercedes Ferrari McLaren Red Bull preview
- acceptance:
...
- task_id: `canadian_gp:weather`
- source_class: `weather`
- priority: `P0`
- reliability_floor: `0.7`
- model_metrics: `wet_skill, strategy, reliability, qualifying_pace`
- queries:
  - Canadian Grand Prix 2026-05-24 weather forecast race rain wind track temperature
  - Canadian Grand Prix 2026-05-24 circuit weather radar F1
  - Canadian Grand Prix 2026-05-24 qualifying race forecast
- acceptance:
...
- task_id: `canadian_gp:structured-session-data`
...
- queries:
  - OpenF1 Canadian Grand Prix 2026-05-24 laps stints weather race control
  - FastF1 Canadian Grand Prix 2026-05-24 session results lap times
  - Canadian Grand Prix 2026-05-24 long run pace tyre degradation F1
- acceptance:
...
- task_id: `canadian_gp:market-rules`
- source_class: `market`
- priority: `P1`
- reliability_floor: `0.65`
- model_metrics: `strategy`
- queries:
  - Canadian Grand Prix Polymarket winner market rules 2026-05-24
  - Canadian Grand Prix Polymarket F1 podium pole fastest lap market
  - Canadian Grand Prix prediction market final classification rules
- acceptance:
...
- task_id: `canadian_gp:independent-media-corroboration`
- source_class: `media`
- priority: `P2`
- reliability_floor: `0.7`
...
- queries:
  - Canadian Grand Prix 2026-05-24 F1 paddock notes named reporting
  - Canadian Grand Prix 2026-05-24 race preview upgrades reliability named sources
  - Canadian Grand Prix 2026-05-24 driver interviews team quotes
- acceptance:
...
## Tool Workflow
1. Run `python -m f1predict.cli prepare-research --event canadian_gp --knowledge-cutoff 2026-05-24T00:00:00+00:00` if workspace files are missing.
...
5. Run `python -m f1predict.cli archive-research-packet --input data/research/canadian_gp/research_packet_template.json --event canadian_gp --knowledge-cutoff 2026-05-24T00:00:00+00:00`.
6. Run `python -m f1predict.cli prediction-packet --event canadian_gp --knowledge-cutoff 2026-05-24T00:00:00+00:00 --iterations 1200 --write` before discussing edge quality.

## Output Contract
- research_packet_path: `data/research/canadian_gp/research_packet_template.json`
- draft_evidence_path: `data/research/canadian_gp/draft_evidence.jsonl`
- source_log_path: `data/research/canadian_gp/source_log.json`
- archive_command: `python -m f1predict.cli archive-research-packet --input data/research/canadian_gp/research_packet_template.json --event canadian_gp --knowledge-cutoff 2026-05-24T00:00:00+00:00`
