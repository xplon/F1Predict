# Codex Research Plan: Austrian Grand Prix
...
- task_id: `austrian_gp:f1-official-fia`
- source_class: `f1_official`
- priority: `P0`
- reliability_floor: `0.9`
- model_metrics: `reliability, strategy, qualifying_pace`
- queries:
  - Austrian Grand Prix 2026-06-28 Formula 1 official preview classification
  - Austrian Grand Prix 2026-06-28 FIA documents race director notes
  - Austrian Grand Prix 2026-06-28 penalties grid changes FIA
- acceptance:
...
- task_id: `austrian_gp:team-updates-track-fit`
...
- queries:
  - Austrian Grand Prix 2026-06-28 team upgrades Mercedes Ferrari McLaren Red Bull Racing
  - Austrian Grand Prix 2026-06-28 track characteristics high_speed F1
  - Austrian Grand Prix 2026-06-28 Mercedes Ferrari McLaren Red Bull preview
- acceptance:
...
- task_id: `austrian_gp:weather`
- source_class: `weather`
- priority: `P0`
- reliability_floor: `0.7`
- model_metrics: `wet_skill, strategy, reliability, qualifying_pace`
- queries:
  - Austrian Grand Prix 2026-06-28 weather forecast race rain wind track temperature
  - Austrian Grand Prix 2026-06-28 circuit weather radar F1
  - Austrian Grand Prix 2026-06-28 qualifying race forecast
- acceptance:
...
- task_id: `austrian_gp:structured-session-data`
...
- queries:
  - OpenF1 Austrian Grand Prix 2026-06-28 laps stints weather race control
  - FastF1 Austrian Grand Prix 2026-06-28 session results lap times
  - Austrian Grand Prix 2026-06-28 long run pace tyre degradation F1
- acceptance:
...
- task_id: `austrian_gp:market-rules`
- source_class: `market`
- priority: `P1`
- reliability_floor: `0.65`
- model_metrics: `strategy`
- queries:
  - Austrian Grand Prix Polymarket winner market rules 2026-06-28
  - Austrian Grand Prix Polymarket F1 podium pole fastest lap market
  - Austrian Grand Prix prediction market final classification rules
- acceptance:
...
- task_id: `austrian_gp:independent-media-corroboration`
- source_class: `media`
- priority: `P2`
- reliability_floor: `0.7`
...
- queries:
  - Austrian Grand Prix 2026-06-28 F1 paddock notes named reporting
  - Austrian Grand Prix 2026-06-28 race preview upgrades reliability named sources
  - Austrian Grand Prix 2026-06-28 driver interviews team quotes
- acceptance:
...
## Tool Workflow
1. Run `python -m f1predict.cli prepare-research --event austrian_gp --knowledge-cutoff 2026-06-28T00:00:00+00:00` if workspace files are missing.
...
5. Run `python -m f1predict.cli archive-research-packet --input data/research/austrian_gp/research_packet_template.json --event austrian_gp --knowledge-cutoff 2026-06-28T00:00:00+00:00`.
6. Run `python -m f1predict.cli prediction-packet --event austrian_gp --knowledge-cutoff 2026-06-28T00:00:00+00:00 --iterations 1200 --write` before discussing edge quality.

## Output Contract
- research_packet_path: `data/research/austrian_gp/research_packet_template.json`
- draft_evidence_path: `data/research/austrian_gp/draft_evidence.jsonl`
- source_log_path: `data/research/austrian_gp/source_log.json`
- archive_command: `python -m f1predict.cli archive-research-packet --input data/research/austrian_gp/research_packet_template.json --event austrian_gp --knowledge-cutoff 2026-06-28T00:00:00+00:00`
